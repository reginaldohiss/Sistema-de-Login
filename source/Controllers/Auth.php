...
class Auth extends Controller
{
    ...
    public function forget($data): void
    {
        ...
        if(!$email)
        {
            echo $this->ajaxResponse("message", [
                "type" => "alert",
                "message" => "Informe o SEU E-MAIL para recuperar senha"
            ]);
            return;
        }
        ...
        if(!$user)
        {
            echo $this->ajaxResponse("message", [
                "type" => "error",
                "message" => "O E-MAIL infomado não é cadastrado"
            ]);
            return;
        }
    ...
    public function reset($data): void
    {
        ...
        flash("success", "Sua senha foi atualizado com sucesso");
        echo $this->ajaxResponse("redirect", [
    ...
    public function socialValidade(User $user): void
    {
        /*
         * FACEBOOK
         */
